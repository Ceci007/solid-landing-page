  ...
  return (
    ...
    <div className="hidden lg:flex">
      <div className="flex items-center space-x-12 cursor-pointer">
        ...
        <button className="border-none bg-transparent text-gray-300 font-semibold hover:text-primary-500 transition-all cursor-pointer">Sign In</button>
        <button className="border-2 border-primary-500 bg-primary-500 py-2 px-6 rounded-4xl text-white font-medium hover:bg-primary-600 hover:border-primary-600 transition-all cursor-pointer">Download</button>
      </div>
    </div>
